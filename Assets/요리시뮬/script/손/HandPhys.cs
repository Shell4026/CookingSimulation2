...
namespace OVRTouchSample
{
    ...
    public class HandPhys : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (left)
                ...
                leftright = Quaternion.Euler(0, 0, 90);
            Quaternion rotdif = hand_pos.rotation * Quaternion.Inverse(transform.rotation * leftright);
            rotdif.ToAngleAxis(out float angle_degree, out Vector3 rot_axis);

            Vector3 rotdifvec = rot_axis * angle_degree;

            rig.angularVelocity = (rotdifvec * Mathf.Deg2Rad) / Time.fixedDeltaTime;
        }
